...
void TFT_ILI9163C::clearScreen(uint16_t color) {
	...
	#if defined(__MK20DX128__) || defined(__MK20DX256__)
		SPI.beginTransaction(ILI9163C_SPI);
		_setAddrWindow(0x00,0x00,_width,_height);
...
void TFT_ILI9163C::drawEllipse(int16_t x, int16_t y, int16_t rx, int16_t ry, uint16_t color)
{
  startWrite();
...
*/
/**************************************************************************/
void TFT_ILI9163C::drawEllipseHelper(int32_t x, int32_t y,
...
*/
/**************************************************************************/
void TFT_ILI9163C::fillEllipse(int16_t x, int16_t y, int16_t rx, int16_t ry, uint16_t color)
{
  startWrite();
...
*/
/**************************************************************************/
void TFT_ILI9163C::fillEllipseHelper(int32_t x, int32_t y,
                                    int32_t rx, int32_t ry,
...
*/
/**************************************************************************/
void TFT_ILI9163C::drawArc(int16_t x, int16_t y, int16_t r1, int16_t r2, float start, float end, uint16_t color)
{
  if (r1 < r2)
  {
    _swap_int16_t(r1, r2);
  ...
  bool equal = fabsf(start - end) < __FLT_EPSILON__;
...
*/
/**************************************************************************/
void TFT_ILI9163C::fillArc(int16_t x, int16_t y, int16_t r1, int16_t r2, float start, float end, uint16_t color)
{
  if (r1 < r2)
  {
    _swap_int16_t(r1, r2);
...
*/
/**************************************************************************/
void TFT_ILI9163C::fillArcHelper(int16_t cx, int16_t cy, int16_t oradius, int16_t iradius, float start, float end, uint16_t color)
{
